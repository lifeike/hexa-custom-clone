...
export class SubmittedOrders extends Component {
  ...
  render() {
    const { orders, styles } = this.props;
    ...
    if (orders && !orders.length) {
      return (
        <OrdersEmptyState type="submitted" />
      );
    }
...
export default withRouter(connect(mapStateToProps, null)(SubmittedOrders));
